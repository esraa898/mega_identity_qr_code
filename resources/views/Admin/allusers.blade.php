...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
						<h4 class="content-title mb-0 my-auto">{{Auth::user()->name}}</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">\Users</span>
						</div>
					</div>
								...
								<div class="table-responsive">
									...
									@foreach ($users as $user)
											<tr>
												...
												<td><img src="{{asset('images/'.$user->name.'/'. $user->photo)}}"/></td>
...
data-title="{{ $user->title }}" data-phone_number="{{ $user->phone_number }}" data-location="{{ $user->location }}"  data-password="{{ $user->password }}"  data-toggle="modal" href="#exampleModal2"
...
<div class="modal" id="modaldemo8" >
			<div class="modal-dialog" role="document">
				<div class="modal-content modal-content-demo">
					<div class="modal-header">
						<h6 class="modal-title">  Change role</h6><button aria-label="Close" class="close" data-dismiss="modal" type="button"><span aria-hidden="true">&times;</span></button>
					</div>
					<div class="modal-body">
